...
@property (nonatomic, strong) NSMutableArray *arrayPropertyRem;
@property (nonatomic, copy) NSMutableArray *arrayPropertyCopy;
@property (assign) CGFloat floatProperty;
/*
